...
def test_chat_stream(server_fixture: subprocess.Popen[str]) -> None:
    ...
    session_url = f"{BASE_URL}/apps/mood_to_meal_butler/users/{user_id}/sessions"
    ...
    for event in events:
        ...
        if content is not None and content.get("parts"):
    ...
    assert has_response_content, "Expected at least one event with text or an input request"
...
@pytest.mark.skip(reason="Feedback endpoint is not implemented in ADK 2.0")
